import { Cloud, Region, ContentstackEndpoints } from './types';
import { getUrlPrefix, getAutomateEndpoint } from './utils';

export function getContentstackEndpoints(cloud: Cloud = 'default', region: Region = 'na'): ContentstackEndpoints {

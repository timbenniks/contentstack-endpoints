...
describe("getContentstackEndpoints", () => {
  ...
  it("should return default NA endpoints when no parameters are provided", () => {
    ...
    expect(endpoints.genAI).toBe("https://ai.contentstack.com/brand-kits");
  });
  ...
  it('should support "us" string for backward compatibility (same as Region.NA)', () => {
    const endpointsUS = getContentstackEndpoints("us");
  ...
  describe("Backward compatibility - v1.x property names", () => {
    ...
    it("should support v1.x personalize alias (maps to personalizeManagement)", () => {
      expect(endpoints.personalize).toBe("https://personalize-api.contentstack.com");
      expect(endpoints.personalize).toBe(endpoints.personalizeManagement);
    });
    ...
    it("should work with all regions", () => {
      ...
      expect(azureEndpoints.brandKitGenAI).toBe("https://azure-na-ai.contentstack.com/brand-kits");
    });
  });

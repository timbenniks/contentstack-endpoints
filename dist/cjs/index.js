...
exports.getContentstackEndpoints = getContentstackEndpoints;
const utils_1 = require("./utils");
function getContentstackEndpoints(cloud = 'default', region = 'na') {
    const prefix = (0, utils_1.getUrlPrefix)(cloud, region);
    const endpoints = {
    ...
    const automateEndpoint = (0, utils_1.getAutomateEndpoint)(cloud, region, prefix);
    if (automateEndpoint) {
